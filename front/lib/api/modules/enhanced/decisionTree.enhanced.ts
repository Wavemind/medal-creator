...
type CreateDecisionTree = CreateDecisionTreeMutation['createDecisionTree']['decisionTree']

type UpdatedDefinitions = {
  getDecisionTrees: OverrideResultType<Definitions['getDecisionTrees'], GetDecisionTrees>
  getDecisionTree: OverrideResultType<Definitions['getDecisionTree'], GetDecisionTree>
  createDecisionTree: OverrideResultType<Definitions['createDecisionTree'], CreateDecisionTree>
}
...
>({
  endpoints: {
    ...
    createDecisionTree: {
      ...
      transformResponse: (response: CreateDecisionTreeMutation): CreateDecisionTree =>
