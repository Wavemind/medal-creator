...
export type GetConditionQuery = {
  getCondition?: {
    ...
    score?: number | null
    answer: { __typename?: 'Answer'; id: string }
...
export type CreateConditionMutation = {
  createCondition?: {
    ...
    condition?: { __typename?: 'Condition'; id: string } | null
  } | null
}
...
export type DestroyConditionMutation = {
  destroyCondition?: {
...
const injectedRtkApi = apiGraphql.injectEndpoints({
  endpoints: build => ({
    ...
    destroyCondition: build.mutation<
      DestroyConditionMutation,
      DestroyConditionMutationVariables
    >({
