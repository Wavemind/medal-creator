  ...
  getVariables: {
    ...
    edges: Array<{
      ...
      node: {
        ...
        answerType: { __typename?: 'AnswerType'; value: string }
      }
    }>
  }
}
...
export type GetVariableQuery = {
  getVariable: {
    __typename?: 'Variable'
    id: string
    isMandatory: boolean
    dependenciesByAlgorithm?: any | null
    labelTranslations: { __typename?: 'Hstore'; en: string; fr: string }
...
export type EditVariableQuery = {
  getVariable: {
    ...
    hasInstances?: boolean | null
    type: Types.VariableCategoryEnum
    system?: Types.SystemEnum | null
    formula?: string | null
    round?: Types.RoundEnum | null
    isMandatory: boolean
    ...
    isPreFill: boolean
    emergencyStatus?: Types.EmergencyStatusEnum | null
    minValueWarning?: number | null
    maxValueWarning?: number | null
    minValueError?: number | null
    maxValueError?: number | null
    labelTranslations: { __typename?: 'Hstore'; en: string; fr: string }
    descriptionTranslations?: {
      __typename?: 'Hstore'
      en: string
    ...
    answers: Array<{
      __typename?: 'Answer'
      id: string
      operator?: Types.OperatorEnum | null
      value?: string | null
      labelTranslations: { __typename?: 'Hstore'; en: string; fr: string }
    }>
    ...
    answerType: { __typename?: 'AnswerType'; id: string }
...
export type DuplicateVariableMutation = {
  duplicateVariable?: {
...
export type DestroyVariableMutation = {
  destroyVariable?: {
...
const injectedRtkApi = apiGraphql.injectEndpoints({
  endpoints: build => ({
    ...
    updateVariable: build.mutation<
      ...
      UpdateVariableMutationVariables
    >({
      query: variables => ({ document: UpdateVariableDocument, variables }),
    }),
    duplicateVariable: build.mutation<
      DuplicateVariableMutation,
      DuplicateVariableMutationVariables
    >({
      query: variables => ({ document: DuplicateVariableDocument, variables }),
    }),
    destroyVariable: build.mutation<
      DestroyVariableMutation,
      DestroyVariableMutationVariables
    >({
