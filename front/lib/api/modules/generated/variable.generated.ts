...
export type EditVariableQuery = { getVariable: { __typename?: 'Variable', hasInstances?: boolean | null, type: Types.VariableCategoryEnum, system?: Types.SystemEnum | null, formula?: string | null, round?: Types.RoundEnum | null, isMandatory: boolean, isUnavailable: boolean, isEstimable: boolean, isNeonat: boolean, isIdentifiable: boolean, isPreFill: boolean, emergencyStatus?: Types.EmergencyStatusEnum | null, minValueWarning?: number | null, maxValueWarning?: number | null, minValueError?: number | null, maxValueError?: number | null, labelTranslations: { __typename?: 'Hstore', en: string, fr: string }, descriptionTranslations?: { __typename?: 'Hstore', en: string, fr: string } | null, answers: Array<{ __typename?: 'Answer', id: string, operator?: Types.OperatorEnum | null, value?: string | null, labelTranslations: { __typename?: 'Hstore', en: string, fr: string } }>, nodeComplaintCategories?: Array<{ __typename?: 'NodeComplaintCategory', complaintCategory: { __typename?: 'Variable', id: string, labelTranslations: { __typename?: 'Hstore', en: string, fr: string } } }> | null, answerType: { __typename?: 'AnswerType', id: string }, minMessageErrorTranslations?: { __typename?: 'Hstore', en: string, fr: string } | null, maxMessageErrorTranslations?: { __typename?: 'Hstore', en: string, fr: string } | null, minMessageWarningTranslations?: { __typename?: 'Hstore', en: string, fr: string } | null, maxMessageWarningTranslations?: { __typename?: 'Hstore', en: string, fr: string } | null, placeholderTranslations?: { __typename?: 'Hstore', en: string, fr: string } | null, files: Array<{ __typename?: 'File', id: string, name: string, size: number, url: string, extension: string }> } };
...
export const CreateVariableDocument = `
    mutation createVariable($labelTranslations: HstoreInput!, $descriptionTranslations: HstoreInput, $answersAttributes: [AnswerInput!]!, $complaintCategoryIds: [ID!], $answerType: ID!, $type: VariableCategoryEnum!, $projectId: ID, $system: SystemEnum, $formula: String, $round: RoundEnum, $isMandatory: Boolean, $isUnavailable: Boolean, $isEstimable: Boolean, $isNeonat: Boolean, $isIdentifiable: Boolean, $isPreFill: Boolean, $emergencyStatus: EmergencyStatusEnum, $minValueWarning: Int, $maxValueWarning: Int, $minValueError: Int, $maxValueError: Int, $minMessageErrorTranslations: HstoreInput, $maxMessageErrorTranslations: HstoreInput, $minMessageWarningTranslations: HstoreInput, $maxMessageWarningTranslations: HstoreInput, $placeholderTranslations: HstoreInput, $filesToAdd: [Upload!]) {
  createVariable(
...
export const UpdateVariableDocument = `
    mutation updateVariable($id: ID!, $labelTranslations: HstoreInput!, $descriptionTranslations: HstoreInput, $answersAttributes: [AnswerInput!]!, $complaintCategoryIds: [ID!], $answerType: ID!, $type: VariableCategoryEnum!, $projectId: ID, $system: SystemEnum, $formula: String, $round: RoundEnum, $isMandatory: Boolean, $isUnavailable: Boolean, $isEstimable: Boolean, $isNeonat: Boolean, $isIdentifiable: Boolean, $isPreFill: Boolean, $emergencyStatus: EmergencyStatusEnum, $minValueWarning: Int, $maxValueWarning: Int, $minValueError: Int, $maxValueError: Int, $minMessageErrorTranslations: HstoreInput, $maxMessageErrorTranslations: HstoreInput, $minMessageWarningTranslations: HstoreInput, $maxMessageWarningTranslations: HstoreInput, $placeholderTranslations: HstoreInput, $filesToAdd: [Upload!], $existingFilesToRemove: [Int!]) {
  updateVariable(
    input: {params: {id: $id, labelTranslations: $labelTranslations, descriptionTranslations: $descriptionTranslations, answersAttributes: $answersAttributes, complaintCategoryIds: $complaintCategoryIds, answerTypeId: $answerType, type: $type, projectId: $projectId, system: $system, formula: $formula, round: $round, isMandatory: $isMandatory, isUnavailable: $isUnavailable, isEstimable: $isEstimable, isNeonat: $isNeonat, isIdentifiable: $isIdentifiable, isPreFill: $isPreFill, emergencyStatus: $emergencyStatus, minValueWarning: $minValueWarning, maxValueWarning: $maxValueWarning, minValueError: $minValueError, maxValueError: $maxValueError, minMessageErrorTranslations: $minMessageErrorTranslations, maxMessageErrorTranslations: $maxMessageErrorTranslations, minMessageWarningTranslations: $minMessageWarningTranslations, maxMessageWarningTranslations: $maxMessageWarningTranslations, placeholderTranslations: $placeholderTranslations}, filesToAdd: $filesToAdd, existingFilesToRemove: $existingFilesToRemove}
  ) {
    variable {
      id
    }
