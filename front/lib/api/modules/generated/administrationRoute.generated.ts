...
export type GetAdministrationRoutesQueryVariables = Types.Exact<{
  [key: string]: never
}>

export type GetAdministrationRoutesQuery = {
  getAdministrationRoutes: Array<{
...
const injectedRtkApi = apiGraphql.injectEndpoints({
  endpoints: build => ({
    getAdministrationRoutes: build.query<
      GetAdministrationRoutesQuery,
      GetAdministrationRoutesQueryVariables | void
    >({
      query: variables => ({
