...
export type ManagementFieldsFragment = {
...
export type CreateManagementMutation = {
  createManagement?: {
    ...
    management?: { __typename?: 'Management'; id: string } | null
  } | null
}
...
export type DestroyManagementMutation = {
  destroyManagement?: {
...
const injectedRtkApi = apiGraphql.injectEndpoints({
  endpoints: build => ({
    ...
    updateManagement: build.mutation<
      ...
      UpdateManagementMutationVariables
    >({
      query: variables => ({ document: UpdateManagementDocument, variables }),
    }),
    destroyManagement: build.mutation<
