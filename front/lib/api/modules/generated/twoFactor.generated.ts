...
export type GetOtpRequiredForLoginQuery = {
  getOtpRequiredForLogin: {
    __typename?: 'User'
    otpRequiredForLogin?: boolean | null
  }
}
...
export type Enable2faMutation = {
  enable2fa?: { __typename?: 'Enable2faPayload'; id?: string | null } | null
}
...
export type Disable2faMutation = {
  disable2fa?: { __typename?: 'Disable2faPayload'; id?: string | null } | null
}
...
const injectedRtkApi = apiGraphql.injectEndpoints({
  endpoints: build => ({
    ...
    getOtpRequiredForLogin: build.query<
      GetOtpRequiredForLoginQuery,
      GetOtpRequiredForLoginQueryVariables
    >({
      query: variables => ({
