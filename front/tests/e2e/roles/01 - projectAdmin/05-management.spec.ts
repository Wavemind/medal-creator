...
import { ManagementsPage } from '@/tests/pageObjectModels/managements'

test.describe('Check project admin management permissions', () => {
  let managementsPage: ManagementsPage

  test.beforeEach(async ({ projectAdminContext }) => {
    managementsPage = new ManagementsPage(projectAdminContext)
