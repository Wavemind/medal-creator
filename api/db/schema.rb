...
ActiveRecord::Schema[7.0].define(version: 20_221_012_093_844) do
  ...
  create_table 'instances', force: :cascade do |t|
    ...
    t.index %w[instanceable_type instanceable_id], name: 'index_instances_on_instanceable'
  ...
  create_table 'media', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[fileable_type fileable_id], name: 'index_media_on_fileable'
  end
  ...
  create_table 'webauthn_credentials', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[name external_id user_id], name: 'index_webauthn_credentials_on_name_and_external_id_and_user_id',
                                          unique: true
