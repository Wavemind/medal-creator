...
RSpec.describe Api::V2::AlgorithmsController, type: :controller do
  it 'Get algorithms of a project' do
    get :index, params: { project_id: Project.first.old_medalc_id }, xhr: true
  ...
  it 'Throws error if the project does not exist' do
    get :index, params: { project_id: 999 }, xhr: true
  ...
  it 'Gets medal_data config from an algorithm' do
    get :medal_data_config, params: { project_id: Project.first.id, id: Algorithm.first.old_medalc_id }, xhr: true
