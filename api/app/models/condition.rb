...
class Condition < ApplicationRecord
  ...
  def remove_children
    ...
    child = Child.find_by(instance: parent_node.instances.find_by(instanceable: child_instance.instanceable, diagnosis: child_instance.diagnosis), node: child_instance.node)
