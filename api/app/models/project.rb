...
class Project < ApplicationRecord
  ...
  def create_default_variables
    ...
    bmi = variables.create!(label_translations: Hash[Language.all.map(&:code).collect { |k| [k, I18n.t('variables.default_variables.bmi', locale: k)] } ], type: 'Variables::BasicMeasurement', step: Variable.steps[:basic_measurements_step], stage: Variable.stages[:registration], answer_type_id: 5, formula: '[BM1] / (([BM3] / 100) * ([BM3] / 100))', is_default: true)
